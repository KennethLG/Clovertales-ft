...
export const cards = [
  {
    ...
    videoUrl: `${config.aws.cdn}/overview/overview-flowers.mp4`,
    description:
  ...
  },
  {
    ...
    videoUrl: `${config.aws.cdn}/overview/overview-forest.mp4`,
    description:
  ...
  {
    title: "Fantastic monsters",
    videoUrl: `${config.aws.cdn}/overview/overview-snow.mp4`,
    description:
